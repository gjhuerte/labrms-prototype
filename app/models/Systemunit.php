...
class Systemunit extends Eloquent{
	...
	//Database driver
		...
		*/
		...
		public static $rules = array(
			'system unit serial id' => 'required|min:5|max:100|unique:itemprofile,serialid',
			'system unit property number' => 'required|min:5|max:100|unique:itemprofile,property_number',
		...
		public static $updateRules = array(
			'system unit serial id' => 'required|min:5|max:100',
			'system unit property number' => 'required|min:5|max:100',
			'MR number' =>'required|min:5|max:50',
			'status' =>'required|min:5|max:50',
			'description' =>'required|min:5|max:100',
