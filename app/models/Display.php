	...
	//Database driver
		...
		*/
		...
		public static $rules = array(
			'display serial id' => 'required|min:5|max:100|unique:itemprofile,serialid',
			'display property number' => 'required|min:5|max:100|unique:itemprofile,property_number',
		...
		public static $updateRules = array(
			'display serial id' => 'required|min:5|max:100',
			'display property number' => 'required|min:5|max:100',
			'MR number' =>'required|min:5|max:50',
			'status' =>'required|min:5|max:50',
			'description' =>'required|min:5|max:100',
