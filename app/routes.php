...
Route::group(['before'=>'auth|admin'], function () {
	...
	*/
	...
	Route::get('inventory/item/view/{id}/add',[
		'as' => 'inventory.item.view.add',
		'uses'=>'ItemInventoryController@addView'
	]);

	Route::post('inventory/item/{id}/add',[
		'as' => 'inventory.item.add',
		'uses'=>'ItemInventoryController@add'
	]);

	Route::get('inventory/item/view/import',[
		'as'=> 'inventroy.item.view.import',
		'uses' => 'ItemInventoryController@importView'
	]);

	Route::post('inventory/item/view/import',[
		'as'=> 'inventroy.item.import',
