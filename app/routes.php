...
*/
	...
	Route::resource('workstation/view/software','WorkstationSoftwareController');
/*
|--------------------------------------------------------------------------
| Software
|--------------------------------------------------------------------------
...
*/
	...
	Route::get('get/item/profile/systemunit/all',[
		'as' => 'item.profile.systemunit.all',
		'uses' => 'ItemsAjaxController@getAllSystemUnit'
	]);

	Route::get('get/item/profile/monitor/all',[
		'as' => 'item.profile.monitor.all',
		'uses' => 'ItemsAjaxController@getAllMonitor'
	]);

	Route::get('get/item/profile/avr/all',[
		'as' => 'item.profile.avr.all',
		'uses' => 'ItemsAjaxController@getAllAVR'
	]);

	Route::get('get/item/profile/keyboard/all',[
		'as' => 'item.profile.keyboard.all',
		'uses' => 'ItemsAjaxController@getAllKeyboard'
	]);
	Route::get('get/workstation/tableform/all',[
		'as' => 'workstation.tableform.all',
		'uses' => 'WorkstationController@getAllWorkstationInTableForm'
	]);
