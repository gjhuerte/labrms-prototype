...
Route::group(['before'=>'auth'],function(){
	...
	Route::get('reservation/create',['as'=>'reservation.create','uses'=>'ReservationController@create']);
...
*/
	...
	Route::resource('inventory/room/assign','RoomInventoryAssignmentController');
	// room inventory view
...
Route::group(['before'=>'auth|admin'], function () {
	...
	Route::get('getItemTypes','ItemsController@getItemTypes');
	...
	Route::get('getItemBrands',[
		'as' => 'inventory.item.getItemBrands',
		'uses' => 'ItemsController@getItemBrands'
	]);
	//returns list of Models
	//uses ItemsController
	Route::get('getItemModels',[
		'as' => 'inventory.item.getItemModels',
		'uses' => 'ItemsController@getItemModels'
	]);
	//returns list of propertynumber
	//uses ItemsInventoryController
	Route::get('getPropertyNumber',[
		'as' => 'inventory.item.getPropertyNumber',
		'uses' => 'ItemsController@getPropertyNumber'
	]);
});
