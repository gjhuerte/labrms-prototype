	...
	public function store()
	{
		...
		*/
		...
		foreach(Input::get('workstation') as $workstation)
		{
			...
			$details = "Equipment received and profiled on ".Carbon\Carbon::now()->toFormattedDateString();
			Ticket::generateTicket($systemunit_itemprofile->id,'receive',$details,Auth::user()->firstname." ".Auth::user()->lastname,Auth::user()->id,null,'Closed');
			...
			$details = "Equipment received and profiled on ".Carbon\Carbon::now()->toFormattedDateString();
			Ticket::generateTicket($monitor_itemprofile->id,'receive',$details,Auth::user()->firstname." ".Auth::user()->lastname,Auth::user()->id,null,'Closed');
