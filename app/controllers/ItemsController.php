...
class ItemsController extends \BaseController {
	...
	public function getItemTypes(){
		if(Request::ajax())
		{
			$itemtypes = Inventory::select('itemtype')->get();
	...
	public function getItemBrands(){
		...
		{
			if(isset($itemtypes)){
				$brands = Inventory::where('brand',$itemtypes)->select('brand')->get();
			}else{
	...
	public function getItemModels(){
		...
		{
			if(isset($model)){
				$models = Inventory::where('model',$model)->select('model')->get();
			}else{
	...
	public function getPropertyNumber(){
		if(Request::ajax()){
			...
			$inventory = Inventory::where('model',$model)->where('brand',$brand)->where('itemtype',$itemtype)->select('id')->first();
