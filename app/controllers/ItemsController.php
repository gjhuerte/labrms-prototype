...
class ItemsController extends \BaseController {
	...
	public function store()
	{
		...
		$propertynumber = $this->sanitizeString(Input::get('propertyid'));
		$serialnumber = $this->sanitizeString(Input::get('serialid'));
		...
		Itemprofile::data($propertynumber,$serialnumber,$datereceived,$inventory_id,$receipt_id);
