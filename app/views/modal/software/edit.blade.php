		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<div id="edit-page-one">
					...
					<div class="form-group">
						<div class="col-sm-12">
				            ...
				            <div class="material-switch pull-right">
				                <input id="edit-multiple" name="multiple" type="checkbox"/>
				                <label for="edit-multiple" class="label-success"></label>
				            </div>
					...
					<div class="form-group">
						<div class="col-sm-12">
							<button type="button" class="btn btn-primary col-md-offset-9 col-md-3" id="edit-next">Next</button>
						</div>
					</div>
				</div>
