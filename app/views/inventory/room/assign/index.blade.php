...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function init(){
      ...
      setBrand();
      setModel();
      setTimeout(setPropertyNumber,1000);
      setRooms();
    }
    ...
    function setItemType(){
      $.ajax({
          type:'get',
          url:'{{ url("getItemTypes") }}',
          dataType:'json',
          success:function(response){
            var item = "";
            for(ctr = 0;ctr < response.length;ctr++)
            {
              item = setSelectBoxItem(item,response[ctr].itemtype,response[ctr].itemtype);
            }
