						...
						<td class="col-md-2 col-xs-2">
							<div class="btn-group btn-group-justified" role="group">
								<div class="btn-group" role="group">
									<button class="btn btn-default btn-flat profile" type="button">
									  <span class="glyphicon glyphicon-pecil" aria-hidden="true"></span> <span class="hidden-sm hidden-xs">Profile</span>
									</button>
								</div>
								<div class="btn-group" role="group">
...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $('#inventoryTable').DataTable({
	 	...
	 	$("div.toolbar").html(`
				<button class="btn btn-flat btn-md btn-primary" data-toggle='modal' data-target='#createInventoryModal' style="padding: 10px;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <span id="nav-text">Create</span></button>
		`);
