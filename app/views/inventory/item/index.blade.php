...
<script type="text/javascript">
    ...
    $('#inventoryTable').DataTable({
    	...
    	"dom": "<'row'<'col-sm-6'<'toolbar'>><'col-sm-3 text-center'><'col-sm-3'f>>" +
	 	...
	 	$("div.toolbar").html(`
				<button class="btn btn-flat btn-md btn-default" id="simple-menu" href="#sidr" style="padding: 6px;"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> <span id="nav-text">Toggle Navigation</span></button>
		`);
