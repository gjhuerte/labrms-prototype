	    ...
	    function insertForm(row)
	    {
	      $('tbody').append(`
				<tr>
					<td>`+row+`</td>
					<td>
						<input type="text" name="propertynumber`+(row-1)+`" class="form-control" placeholder="Property Number">
					</td>
					<td>
						<input type="text" name="serialid`+(row-1)+`" class="form-control" placeholder="Serial Number">
					</td>
				</tr>
	      `)
	    }
