			...
			<ol class="breadcrumb">
	 		...
	 		<div id="inventory">
				...
				<div id="page-two">
					...
					<div class="form-group">
						<div class="col-sm-offset-4 col-sm-4">
							<button type="submit" value="create" name="action" id="submit" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Submit </button>
						</div>
						<div class="col-sm-4">
