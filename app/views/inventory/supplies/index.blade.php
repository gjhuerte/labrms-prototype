    ...
    var table = $('#inventoryTable').DataTable({
		...
		"processing": true,
	 	...
	 	$("div.toolbar").html(`
				...
				<button id="edit" class="btn btn-warning btn-flat" type="button" style="padding: 10px;">
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
					<span class="hidden-sm hidden-xs"> Update Information</span>
				</button>
				<button id="consume" class="btn btn-danger btn-flat" type="button" style="padding: 10px;">
					<span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span>
					<span class="hidden-sm hidden-xs"> Consume</span>
				</button>
		`);
