	...
	$(document).ready(function() {
    	...
    	var table = $('#workstationTable').DataTable( {
	 	...
	 	$("div.toolbar").html(`
	 			...
	 			<a id="new" class="btn btn-primary btn-flat" style="margin-right:5px;padding: 5px 10px;" href="{{ url('workstation/create') }}"><span class="glyphicon glyphicon-plus"></span>  Assemble</a>
