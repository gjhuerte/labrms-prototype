  ...
  $(document).ready(function(){
    ...
    $('#quantity-to-profile').on('focusin change keyup keypress',function(){
      ...
      if(quantity > 50)
      {
          ...
          $('#quantity-to-profile').after('<p class="text-danger" id="quantity-error" style="font-size: 12px;">Warning! Profiling more than 50 set will take longer time to process.</p>')

        $('#quantity-to-profile').val(50)
      }
