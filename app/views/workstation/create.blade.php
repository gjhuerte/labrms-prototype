          ...
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <div class="material-switch pull-right">
                  <input id="keyboard" name="keyboard" type="checkbox" checked="checked"/>
                  <label for="keyboard" class="label-success"></label>
              </div>
  						<p style="font-size: 10px;"><span class="text-primary">Note:</span><span class="text-muted">The default means that keyboard is included</span></p>
  					</div>
  				</div>
