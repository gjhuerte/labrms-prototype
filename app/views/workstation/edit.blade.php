        ...
        <div class = 'form-horizontal'>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <p>
                ...
                <span class="text-muted">{{ $pc->systemunit->propertynumber }}</span>
              </p>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <p>
                <span class="text-danger">Old Value:</span>
                <span class="text-muted">{{ $pc->monitor->propertynumber }}</span>
              </p>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <p>
                <span class="text-danger">Old Value:</span>
                <span class="text-muted">{{ $pc->avr->propertynumber }}</span>
              </p>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              ...
              <p>
                <span class="text-danger">Old Value:</span>
                <span class="text-muted">{{ $pc->keyboard->propertynumber }}</span>
              </p>
          ...
          <div class="form-group">
            <div class="col-sm-12">
              <div class="btn-group btn-group-justified">
                ...
                <div class="btn-group">
                    <button class="btn btn-default btn-lg btn-block btn-flat" type="button" onclick="$(function(){ window.location.href = '{{ url('workstation/view/update') }}';})"><span class="glyphicon glyphicon-share-alt"></span> Cancel</button>
                </div>
              </div>
            </div>
          </div>
