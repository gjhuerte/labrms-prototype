				...
				@else
					...
					<tr>
						...
						<td>
							...
							<button class="btn btn-md btn-warning delete" name="delete" type="submit" value="Condemn"><span class="glyphicon glyphicon-remove" aria-hidden="true"> Remove </span></button>
							{{ Form::close() }}
						</td>
					</tr>
					@endforeach
