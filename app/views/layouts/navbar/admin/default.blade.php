      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li>{{ HTML::link('reservation/items/list','Rules') }}</li>
          </ul> <!-- end of dropdown items -->
        </li> <!-- end of reservation dropdown tab -->
        <!-- workstation dropdown tab -->
        <li class="dropdown">
          <a href="{{ url('ticket') }}">
            <img class="img" src="{{ asset('images/logo/Workstation/workstation-16.png') }}" style="width:25px;height:25px;margin-right: 5px;"> Tickets</a>
