		...
		<div class="col-sm-12 panel panel-body panel-shadow table-responsive">
			<table class="table table-striped table-hover table-bordered" id='itemTypeTable'>
				...
				<tr>
					...
					<td>
						{{ Form::open(['method'=>'delete','route' => array('item.type.destroy',$itemtype->id),'id'=>'deletionForm']) }}
						<button class="btn btn-md btn-danger btn-block delete" name="delete" type="submit" value="Condemn"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> <span class="hidden-xs">Remove</span></button>
						{{ Form::close() }}
					</td>
				</tr>
				@empty
