        ...
        <div id="page-one">
          ...
          <div class="form-group">
            <div class="col-sm-offset-8 col-sm-4">
              <button id="next" class="btn btn-block btn-flat btn-md btn-primary" type="button" style="padding:10px;">
          ...
          <div class="form-group">
            <div class="col-md-12">
              <div class="btn-group col-md-12">
                ...
                <div class="pull-left">
                  <button id="add" data-id = '0' class="add btn btn-flat btn-flat btn-success" type="button" style="padding:10px;">
                    <span class="glyphicon glyphicon-plus"></span> <span class="hidden-xs">Add Fields</span>
                  </button>
                </div>
                <div class="pull-right">
                  <button id="previous" class="btn btn-default btn-flat" type="button" style="padding:10px;"><span class="glyphicon glyphicon-share-alt"></span> <span>Previous</span></button>
                  <button class="btn btn-primary btn-flat" type="submit" style="padding:10px;">
