  ...
  <div class="panel panel-primary" style="border: none;border-radius: 0px;">
    ...
    <div class="panel-body">
      ...
      <dl>
        ...
        <dd class="text-muted" style="padding: 10px;margin: 10px;">Suggested default password is <strong>12345678</strong>. But you can choose different password. <storng>Note:</storng> Password is encrypted so there is no way to view the password. If forgotten, resetting the password is the only solution.</dd>
      </dl>
    </div>
  </div>
</div>
